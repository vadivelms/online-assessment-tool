<%-- 
    ...
    Created on : Feb 5, 2017, 9:54:29 PM
    Author     : vadivel
--%>
...
<html>
    ...
    <body >
    <center> <h1 style="color:red">Register to participate </h1></center>
    <form action="registerservelet">
        <input type="text" name="yid" value="" placeholder="Yuddhavarna_ID" required=""/><br><br>
        <input type="text" name="name" value="" placeholder="Name" required=""/><br><br>
        <input type="text" name="dept" value="" placeholder="Dept" required=""/><br><br>
        <input type="email" name="email" value="" placeholder="email" class="email" required=""/><br><br>
        <input type="text" name="college" value="" placeholder="College" required=""/><br><br>
